...
import com.xzsd.app.image.entity.ImageEntity;
import com.xzsd.app.util.RandomUtil;
...
public class ImageService {
    ...
    public AppResponse upLoadImage(MultipartFile uploadFile) throws IOException {
        ...
        File toFile = File.createTempFile(RandomUtil.radmonkey(),prefix);
        ...
        String secretId = "AKID2yvNhpyX9wWoukTdzHSPWRDlEUVGmEOM";
        String secretKey = "srX5hhW7VotSr4NTKz82UnsjV8eDbfS7";
        ...
        // 指定要上传的文件
        // 指定要上传到的存储桶
        String bucketName = "image-1301912042";
        // 指定要上传到 COS 上对象键
        String key = fileName;
